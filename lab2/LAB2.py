...
def Main():
    ...
    for i in range(3,7):
        EVMs[i].printShortInformaton()
    print()
    EVMs.append(PC("D340MC", "ASUS", "No"))
    EVMs[7].setCase(160, 378, 355, "Miditower")
    EVMs[7].setCooling(1, "No")
    EVMs[7].setPSU("FrimeCom SM350BL", "80 PLUS", 350)
    EVMs[7].printFullInformaton()
    EVMs.append(PC("Matrexx 55", "DeepCool", "Windows 10 Pro x64"))
    EVMs[8].setCase(210, 480, 440,"Miditower")
    EVMs[8].setCPU("Ryzen 5 1600", "PGA", 3.7, 6, True)
    EVMs[8].setMemory(16,"DIMM",4,1024,False,False)
    EVMs[8].setGPU("AMD Radeon RX560", 1800, 4, False)
    EVMs[8].setMotherboard("ASUS PRIME X-370", "AM4", "Realtek ALCS1220A 8-Channel", "Multi-VGA output: Display Port, HDMI", 8, False, False, "ATX")
    EVMs[8].setPSU("Chieftec 600W Proton", "80 PLUS Bronze", 600)
    EVMs[8].setCooling(3, "DeepCool Gammax 400")
    EVMs[8].printFullInformaton()
